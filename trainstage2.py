...
def train(args):
    ...
    train_dataset = loaddataset.Train2Dataset(root='../data/test', transform=config.train1_transform)
    ...
    model = net.SimCLRStage2(num_class=CLASS_NUM).to(DEVICE)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pre_model', default="./pth/model_stage1_epoch200.pth", type=str, help='')  #default=config.pre_model
